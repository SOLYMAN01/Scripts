...
------------------------------------------------------General--------------------------------------------------------
Config = {}
Config.speedUnit = "kmh" -- Default speed unit - kmh or mph
...
Config.RegisterKeyMapping = false  --- if true script uses RegisterKeyMapping system if false you can set keys from NotUseRegisterKeymappingCruiseKey
...
Config.cruisekey = "CAPSLOCK"  -- set this if RegisterKeymmaping is true
Config.NotUseRegisterKeymappingCruiseKey = 171    -- set this if RegisterKeymapping is false  --U-- --- change key == https://docs.fivem.net/docs/game-references/controls/   
Config.NotUseRegisterKeymappingSeatbeltKey = 29  -- set this if RegisterKeymapping is false --X-- --- change key == https://docs.fivem.net/docs/game-references/controls/ 

------------------------------------------------------Notify--------------------------------------------------------

Config.VeniceNotify =  false    --- if true use VeniceNotification or custom notfiy if false use esx shownotification
...
Config.Notify1 ={text = "Cinturon ~g~abrochado~w~", type = 'info', time = 5000 }   -- 
Config.Notify2 ={text = "Cinturon ~r~desabrochado~w~", type = "info", time = 5000 }  -- 
Config.Notify3 = {text = "Limite de velocidad ~g~encendido~w~", type ="info" , time  = 5000}  -- 
Config.Notify4 = {text = "Limite de velocidad ~r~apagado~w~", type ="info" , time  = 5000}  ---
